...
namespace TokenManager.dialog
{
    public partial class SelectOtpType : Form
    {
        ...
        public SelectOtpType(Object obj, string parentAction)
        {
            ...
            title.Text = LanguageUtil.GetInstance().GetValue(LanguageUtil.Key.DIALOG_SELECT_OTP_TITLE);
            Ok.Text = LanguageUtil.GetInstance().GetValue(LanguageUtil.Key.BTN_OK);
            closeBtn.Text = LanguageUtil.GetInstance().GetValue(LanguageUtil.Key.BTN_CLOSE);
        }
