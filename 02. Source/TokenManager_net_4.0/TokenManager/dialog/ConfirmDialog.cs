...
namespace TokenManager.dialog
{
    ...
    public partial class ConfirmDialog : Form, ObserverAble
    {
        ...
        public ConfirmDialog(string message, string actionCode, Object obj)
        {
            ...
            title.Text = lang.GetValue(LanguageUtil.Key.DIALOG_CONFIRM_TITLE);
            ok.Text = lang.GetValue(LanguageUtil.Key.BTN_OK);
            cancel.Text = lang.GetValue(LanguageUtil.Key.BTN_CLOSE);
        }
