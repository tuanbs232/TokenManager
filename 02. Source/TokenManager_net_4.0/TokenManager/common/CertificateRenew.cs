...
namespace TokenManager.common
{
    class CertificateRenew : ObserverAble
    {
        ...
        public void QueryRenew(string userPin)
        {
            ...
            thread.Start();
            string message = LanguageUtil.GetInstance().GetValue(LanguageUtil.Key.RENEW_CERT_QUERY_RENEW);
            notify(message, CommonMessage.MESSAGE_TYPE_ACTION_WITH_LOADING, null);
        }
        ...
        private void HandleQueryRenew()
        {
            ...
            catch (TokenManagerException ex)
            {
                ...
                {
                    main.InvokeErrorDialog(lang.GetValue(LanguageUtil.Key.CHANGEPIN_CHECK_PLUG_TOKEN));
                    return;
                }
                else
                {
            ...
            main.InvokeConfirmDialog(lang.GetValue(LanguageUtil.Key.RENEW_CERT_HAVE_NEW_CERT), CommonMessage.CONFIRM_RENEW_CERT_OK);
        }
        ...
        public void ImportP12Data()
        {
            ...
            Thread thread = new Thread(childThread);
            thread.Start();
            string message = LanguageUtil.GetInstance().GetValue(LanguageUtil.Key.RENEW_CERT_UPDATING);
            notify(message, 
        ...
        private void HandleUpdateData()
        {
            ...
            if(Pkcs11Util.SUCCESSFULL == code)
            {
                ...
                main.InvokeMessageDialog(lang.GetValue(LanguageUtil.Key.RENEW_CERT_SUCCESSFULL));
